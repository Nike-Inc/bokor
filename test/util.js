// Modifications Copyright 2016 Nike, Inc. (https://www.nike.com)
 ...
 describe('#substituteWithRealValues', function() {
  ...
  describe('#logFixtureStatus', function() {
    ...
    it('logs a cache hit if the fixture exists', function() {
      ...
      console.log.args[0][1].should.containEql('cache hit');
      console.log.args[0].should.containEql('my-filename.headers');
      console.log.args[0].should.containEql('my-hash-body');
    });
    ...
    it('logs a cache miss if the fixture does not exist', function() {
      ...
      console.log.args[0][1].should.containEql('cache miss');
      console.log.args[0].should.containEql('my-filename.headers');
      console.log.args[0].should.containEql('my-hash-body');
    });
  ...
  describe('#logFixtureDebugStatus', function() {
    ...
    it('logs a best matching fixture when verbose mode is true', function() {
      ...
      console.log.args[0][1].should.containEql('==== Best matching Fixture ====');
      console.log.args[0].should.containEql('my-missing-filename');
      console.log.args[0].should.containEql('my-best-matching-fixture');
      console.log.args[0].should.containEql('my-best-matching-fixture-file-hash');
    });
  });
  ...
  describe('#constructAndCreateFixtureFolder', function() {
    ...
    it('constructs a folder from all necessary information', function() {
      ...
      folder.should.equal('/global/fixture/dir/test_name/api.example.com/v1');
    });
    ...
    it('ignores the test name if it should use global fixtures', function() {
      ...
      folder.should.equal('/global/fixture/dir/api.example.com/v1');
    });
    ...
    it('gracefully handles no test name', function() {
      ...
      folder.should.equal('/global/fixture/dir/default/api.example.com/v1');
    });
  ...
  describe('#constructFilename', function() {
    ...
    it('constructs using all the available information', function() {
      ...
      filename.should.equal('/global/fixture/dir/test_name/api.example.com/v1/54602f5f5e24d15fb66c0e8e08df4080');
    });
  });
